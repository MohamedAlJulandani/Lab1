...
<main>
    ...
    <label class="title-label" form="review-title" style="font-size: 16px; font-width: bold;">Title</label>
    <input type="text" name="review-title" id="review-title" style="width: 100%; margin-bottom: 10px;">
    <textarea class="form-contrl" id="review-text" name="review" cols="50" rows="3" placeholder="Enter a comment..."></textarea>
